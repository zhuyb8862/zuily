...
<script type="text/javascript">
	...
	/* 	function addpic_zhu() {
	 window
	 .open('/pages/addpic/upLoaderPic.html', 'newwindow',
	 'height=600,width=800,scrollbars= yes,top=200, left=200, z-look=yes');
		...
		<div class="row">
			<div style="padding: 10px 50px 10px;">
				<form class="form-horizontal" role="form"
					...
					<input type="hidden" name="includFeetimes" value="1" id="includFee">
					...
					<input type="hidden" name="excludFeetimes" value="1" id="excludFee">
